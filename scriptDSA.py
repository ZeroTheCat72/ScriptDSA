...
list_of_problems = [
	...
	Problem("Palindrome Number", "Given an integer x, return True if x is a palindrome, and false otherwise.", "2", 'Easy', [
	[[121], [True]],
	[[-121], [False]],
	[[10], [False]]
], []),
	Problem("Longest Palindromic Substring", "Given a string s, return the longest palindromic substring in s.", 'Microsoft IQ 1', 'Medium', [
	[['babad'], ['bab']],
	[['cbbd'], ['bb']]
], [])
...
if sys.argv[1] == '--search':
	...
	Challenge_problem = fetch_problem(sys.argv[2], list_of_problems)
	print(Challenge_problem.get_problem_details())
